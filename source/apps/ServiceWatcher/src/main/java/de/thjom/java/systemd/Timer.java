...
public class Timer extends Unit {
    ...
    private Timer(final Manager manager, final TimerInterface iface, final String objectPath, final String name) throws DBusException {
    ...
    static Timer create(final Manager manager, String name) throws DBusException {
        ...
        return new Timer(manager, iface, objectPath, name);
    }
