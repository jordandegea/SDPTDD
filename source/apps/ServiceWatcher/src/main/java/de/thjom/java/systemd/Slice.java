...
public class Slice extends Unit {
    ...
    private Slice(final Manager manager, final SliceInterface iface, final String objectPath, final String name) throws DBusException {
    ...
    static Slice create(final Manager manager, String name) throws DBusException {
        ...
        return new Slice(manager, iface, objectPath, name);
    }
