...
public class Swap extends Unit {
    ...
    private Swap(final Manager manager, final SwapInterface iface, final String objectPath, final String name) throws DBusException {
    ...
    static Swap create(final Manager manager, String name) throws DBusException {
        ...
        return new Swap(manager, iface, objectPath, name);
    }
