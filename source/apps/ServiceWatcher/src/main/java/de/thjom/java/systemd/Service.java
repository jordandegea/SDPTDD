...
public class Service extends Unit {
    ...
    private Service(final Manager manager, final ServiceInterface iface, final String objectPath, final String name) throws DBusException {
    ...
    static Service create(final Manager manager, String name) throws DBusException {
        ...
        return new Service(manager, iface, objectPath, name);
    }
