...
public abstract class Unit extends InterfaceAdapter {
    ...
    protected Unit(final Manager manager, final UnitInterface iface, final String objectPath, final String name) throws DBusException {
        ...
        this.unitProperties = Properties.create(dbus, objectPath, SERVICE_NAME);
    }
    ...
    public String introspect() throws DBusException {
        Introspectable intro = dbus.getRemoteObject(Systemd.SERVICE_NAME, objectPath, Introspectable.class);
