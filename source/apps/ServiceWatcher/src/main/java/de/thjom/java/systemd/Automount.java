...
public class Automount extends Unit {
    ...
    private Automount(final Manager manager, final AutomountInterface iface, final String objectPath, final String name) throws DBusException {
    ...
    static Automount create(final Manager manager, String name) throws DBusException {
        ...
        return new Automount(manager, iface, objectPath, name);
    }
