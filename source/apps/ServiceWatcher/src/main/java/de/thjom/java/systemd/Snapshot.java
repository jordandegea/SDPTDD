...
public class Snapshot extends Unit {
    ...
    private Snapshot(final Manager manager, final SnapshotInterface iface, final String objectPath, final String name) throws DBusException {
    ...
    static Snapshot create(final Manager manager, String name) throws DBusException {
        ...
        return new Snapshot(manager, iface, objectPath, name);
    }
