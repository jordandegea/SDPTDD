...
public class Socket extends Unit {
    ...
    private Socket(final Manager manager, final SocketInterface iface, final String objectPath, final String name) throws DBusException {
    ...
    static Socket create(final Manager manager, String name) throws DBusException {
        ...
        return new Socket(manager, iface, objectPath, name);
    }
